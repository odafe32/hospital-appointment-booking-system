    ...
    <div class="container">
                ...
                <tr>
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            ...
                            <tr>
                                <td colspan="2">
                                <a href="../logout.php" ><input type="button" background-color:darkred; color: white; value="Log out" class="logout-btn btn-primary-soft btn" style="background-color:darkred; color: white;"></a>
                                </td>
                            </tr>
                    </table>
                    </td>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="doctors.php" ><button  class="login-btn btn-primary-soft btn    "  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px;background-color:darkred; color: white;"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Staff Number" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="Staff Number" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
